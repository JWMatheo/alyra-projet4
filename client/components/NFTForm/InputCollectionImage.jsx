...
const InputCollectionImage = ({ hiddenFileInput, setNFTImage, NFTImage, setNFTPropertie }) => {
  return (
    <ContainerInputImage>
      <h3>
      ...
      { NFTImage && (
        <p id="image-uploaded">
          {NFTImage.length} image{NFTImage.length > 1 ? 's' : ''} uploaded
        </p>
      )}
...
export default InputCollectionImage;
